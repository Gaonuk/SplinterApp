...
<form align="center" action="usuario/login.php" method="post">
  ...
  <form align="center" action="consultas/consulta_username.php" method="post">
    Username:
    <input type="text" name="username">
    <br/><br/>
    <input type="submit" value="Buscar">
  ...
  <form align="center" action="consultas/consulta_dinero_tickets.php" method="post">
    User ID:
  ...
  <form align="center" action="consultas/consulta_enero_marzo.php" method="post">
    <input type="submit" value="Buscar">
  </form>
  <br>
  <br>
...
<form align="center" action="consultas/consulta_dinero_hoteles.php" method="post">
  Fecha Inicio
